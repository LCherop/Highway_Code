...
class CreateCommittedOffencesFinalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('committed_offenses_final', function (Blueprint $table) {
            $table->id('co_ID');
        ...
        Schema::table('committed_offenses_final', function (Blueprint $table) {
